...
function CreateRestaurant() {
  ...
  /* COMMON INPUT STYLE */
  const inputStyle =
    "w-full bg-black/30 border border-white/20 rounded-lg px-4 py-3 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500";
      ...
      <div className="w-full max-w-6xl bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl p-8 md:p-12">
        ...
        <form onSubmit={handleSubmit} className="space-y-10">
          ...
          <div className="bg-white/5 p-6 rounded-xl border border-white/10">
            <h2 className="text-indigo-400 text-lg font-semibold mb-4">
              Restaurant Info
            </h2>
